...
public class Rational {
    ...
    public Rational add(Rational other) {
        ...
        long sum = (this.x * other.y) + (other.x * this.y);
        long sum2 = this.y * other.y;

        return new Rational(sum, sum2);
    }

    // Returns the product of this rational number and other.
    public Rational multiply(Rational other) {
        // Product of rationals a/b and c/d is the rational ac / bd.
        long product = (this.x * other.x) / (this.y * other.y);
        long product2 = (this.y * other.y);

        return new Rational(product, product2);
    }
